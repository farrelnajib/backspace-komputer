                                    ...
                                    <?php foreach ($categories as $categories) : ?>
                                        <tr>
                                            ...
                                            <td width="150px" align="center">
                                                <a href="<?php echo base_url('admin/categories/edit/') . $categories->category_id; ?>" class="btn btn-success btn-sm">
                                                    Edit <i class="far fa-edit"></i>
                                                </a>
                                                <a href="<?php echo base_url('admin/categories/delete/') . $categories->category_id; ?>" class="btn btn-danger btn-sm">
